...
<ul style={{ marginTop: 100, textAlign: 'left' }}>
  <Appear>
    ...
    <li>This is a feature proposal aka <b>it is in alpha</b></li>
...
<ul style={{ marginTop: 100, textAlign: 'left' }}>
  <Appear>
    <li>Only call Hooks <b>at the top level</b>. Don’t call Hooks inside loops, conditions, or nested functions</li>
    <li>Only call Hooks <b>from React function components</b>. Don’t call Hooks from regular JavaScript functions</li>
  </Appear>
</ul>
