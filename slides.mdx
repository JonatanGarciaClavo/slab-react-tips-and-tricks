...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [25, 30], notes: 'componentDidMount' },
    { range: [20, 24], notes: 'update function' },
    { range: [31, 35], notes: 'componentDidUpdate' },
    { range: [76, 97], notes: 'render' },
    { range: [37, 42], notes: 'handleNewChange' },
    { range: [42, 51], notes: 'handleNewSubmit' },
    { range: [52, 58], notes: 'handleDelete' },
    { range: [59, 67], notes: 'handleCompletedToggle' },
    { range: [68, 72], notes: 'handleThemeChange' },
  ]}
/>
---
# Exercise
