...
<ul>
  <li><code>git clone https://github.com/JonatanGarciaClavo/slab-react-tips-and-tricks.git</code></li>
  <li><code>cd slab-react-tips-and-tricks</code></li>
  <li><code>npm install</code> or <code>yarn install</code></li>
  <li><code>npm run start</code> or <code>yarn start</code></li>
</ul>
...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [36, 41], notes: "render" },
    { range: [22, 34], notes: "Virtualized grid component" },
    { range: [15, 20], notes: "Cell renderer function" },
  ]}
/>
...
// TODO: immutable data structure comparison and change.
...
<ul>
  <Appear>
    ...
    <li>Because of that, lets try to help reconciliation algorithm to take easy and fast decisions.</li>
  </Appear>
</ul>
...
<div style={{fontSize: '20px'}}>
  <CodeSurfer
    ...
    steps={[
      ...
      { range: [100, 104], notes: 'Use all our selectors' },
    ]}
  />
</div>
...
<CodeSurfer
  ...
  theme={vsDark}
  steps={[
    { range: [10, 100], notes: 'todo class' },
    { range: [11, 19], notes: 'constructor' },
    { range: [30, 37], notes: 'componentDidMount' },
    { range: [21, 29], notes: 'update function' },
    { range: [38, 42], notes: 'componentDidUpdate' },
    { range: [89, 119], notes: 'render' },
    { range: [43, 47], notes: 'handleNewChange' },
    { range: [48, 64], notes: 'handleNewSubmit' },
    { range: [65, 71], notes: 'handleDelete' },
    { range: [72, 82], notes: 'handleCompletedToggle' },
    { range: [83, 87], notes: 'handleThemeChange' },
  ]}
/>
