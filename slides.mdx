...
<h4>We want to show you a few tips, tricks, patterns, etc. that will help you in your day work</h4>
...
<ol>
  ...
  <li>👀 Check when click in both buttons how DOM it is updated.</li>
...
<div>This exercise it is a bit different compared with other ones, in this case you need to apply all tips and techniques learned before. That means you need to find and identify issues and try to fix it.</div>
